...
export default function Dashboard() {
  ...
  const handleSubmit = async(e) => {
    ...
    await axios.post("http://localhost:4100/transactions",formData,{
  ...
  const handleLogOut = async(e) => {
    e.preventDefault();
    try{
    await axios.get("http://localhost:4100/logout",{
      withCredentials:true
    }).then(res=>{
      window.location.reload()
    })
        ...
        <Title>New Transaction</Title>
          <form onSubmit={handleSubmit}>
            ...
            <Grid container spacing={2} style={{marginTop:5}}>
              <Grid item xs={6}>
                <Button type="submit" fullWidth style={{color:"white",backgroundColor:"#1976D2",borderRadius:10}}>
                  Submit
                </Button>
              </Grid>
              <Grid item xs={6}>
                <Button onClick={handleClose} fullWidth style={{color:"white",backgroundColor:"red",borderRadius:10}}>
                  Close
                </Button>
              </Grid>
            </Grid>
